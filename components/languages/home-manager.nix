...
let
  ...
  getLanguageConfig = language:
    ...
    then import availableLanguages.${language} { inherit pkgs; username = config.home.username; }
    else null;
...
in {
  config = mkIf (hasPersonalConfig && languageConfig.hasConfig) (mkMerge [
    ...
    (mkIf (languageConfig.userShell == "zsh") {
      ...
      programs.zsh.initContent = mkIf (languageConfig.cfg.shellInitExtra.zsh != "") languageConfig.cfg.shellInitExtra.zsh;
    })
